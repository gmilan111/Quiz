    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid fofejlec">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                <a class="nav-link aktiv szoveg" href="tarsasverseny.php">Társasverseny</a>
                </li>
                <li class="nav-item">
...
<?php
        ...
        $stid = oci_parse($conn, "SELECT * FROM tarsasverseny");
        $stid2 = oci_parse($conn, "SELECT * FROM jelentkezes");
